...
<div class="container-fluid p-3">
	<div class="row">
		<div class="col-md-3 text-success">
			<h3>
				<i class="fas fa-book"></i> The Big Bookshelf
			</h3>
		</div>
		...
		<c:if test="${not empty userobj}">
			...
			<a href ="cart.jsp"><i class="fas fa-cart-plus fa-2x"></i></a>
				...
				<a href="login.jsp" class="btn btn-success">Hello ${userobj.name} </a>
					 <a href="logout" class="btn btn-primary"><i class="fas fa-sign-in-alt"></i>
					Logout </a>
			</div>
